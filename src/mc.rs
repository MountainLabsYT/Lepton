...
impl Camera {
    //const ATTRIBS: [wgpu::VertexAttribute; 6] = wgpu::vertex_attr_array![0 => Float32x3, 1 => Float32x3, 2 => Float32x3, 3 => Float32, 4 => Float32, 5 => Float32];
}
...
impl<'a> State<'a> {
    ...
    fn update(&mut self) {
        // update camera somehow        self.camera_controller.update_camera(&mut self.camera);
        self.queue
